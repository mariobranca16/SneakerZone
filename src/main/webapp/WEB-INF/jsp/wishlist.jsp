...
<main>
    <div class="wishlist-page">
        ...
        <c:if test="${param.erroreCarrello == '1'}">
            <div class="alert alert-error">Non puoi aggiungere piu prodotti di quanti siano disponibili.</div>
        </c:if>
        ...
        <c:choose>
            <c:when test="${empty prodotti}">
                <div class="wishlist-empty-state">
                    ...
                    <p class="wishlist-empty-text">Non hai ancora aggiunto prodotti alla tua wishlist. Esplora il catalogo per trovare le scarpe che ami.</p>
                    <div class="wishlist-empty-actions">
                        <a class="wishlist-cta wishlist-cta-primary" href="${pageContext.request.contextPath}/catalogo">
                            Vai al catalogo
                        </a>
                    </div>
                </div>
                ...
                <div class="wishlist-grid">
                    <c:forEach var="p" items="${prodotti}">
                        <div class="wishlist-item">
                            ...
                            <%-- Riga principale: immagine + info + prezzo --%>
                            <div class="wishlist-item-top">
                                <div class="wishlist-item-media">
                                    ...
                                    <div class="wishlist-item-text">
                                        <a class="wishlist-item-nome" href="${pageContext.request.contextPath}/prodotto?id=${p.id}">
                                            <c:out value="${p.nome}"/>
                                        </a>
                                        <span class="wishlist-item-brand"><c:out value="${p.brand}"/></span>
                                    </div>
                                </div>
                                <span class="wishlist-item-prezzo"><fmt:formatNumber value="${p.costo}" type="number" minFractionDigits="2" maxFractionDigits="2"/><span class="currency">&euro;</span></span>
                            </div>

                            <%-- Riga azioni: form carrello + rimuovi --%>
                            <div class="wishlist-item-actions">
                                <c:set var="taglieDisponibili" value="${disponibilitaPerProdotto[p.id]}"/>

                                <c:choose>
                                    <c:when test="${not empty taglieDisponibili}">
                                        <form class="wishlist-cart-form" method="post" action="${pageContext.request.contextPath}/carrello">
                                            ...
                                            <div class="wishlist-cart-fields">
                                                ...
                                                <div class="wishlist-field">
                                                    ...
                                                    <input id="qta-${p.id}" type="number" name="quantita" min="1" value="1" required/>
                                                </div>
                                            </div>
                                ...
                                <form class="wishlist-remove-form" method="post" action="${pageContext.request.contextPath}/remove-from-wishlist">
